...
app.use(cors)
const uri = "mongodb+srv://nexuslearning:amarkc551@cluster0.hqmeltf.mongodb.net/?retryWrites=true&w=majority";
const client = new MongoClient(uri, { useNewUrlParser: true, useUnifiedTopology: true, serverApi: ServerApiVersion.v1 });
client.connect(err => {
  const collection = client.db("TeamsDB").collection("messages");
...
mongoose.connect(process.env.MONGO_OPENURI, {
